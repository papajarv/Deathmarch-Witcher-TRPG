...
const SUBSYSTEM_META = () => Object.freeze([
    { key: "guards",       label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.GuardStances", "Guard stances"),
      hint: "Balanced / Warding / Closed / Fool's stances + dock guard button + per-weapon Warding location pick." },
    { key: "raiseShield",  label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.RaiseShield", "Raise Shield"),
    ...
    { key: "actionCosts",  label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.CombatExtendedActionCosts", "Combat-Extended action costs"),
    ...
    { key: "defenseCosts", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.CombatExtendedDefenseCosts", "Combat-Extended defense costs"),
    ...
    { key: "eoArmorModel", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.EOArmorModelArmingJacksNew", "EO armor model (arming jacks + new EV)"),
...
const TUNEABLE_META = () => Object.freeze([
    { key: "additiveDefenseRecurrence", kind: "boolean", default: true,
      label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.AdditiveDefenseRecurrence", "Additive defense recurrence"),
    ...
    { key: "raiseShieldAutoBalanced", kind: "boolean", default: true,
      label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.RaiseShieldBalancedGuard", "Raise Shield → Balanced guard"),
    ...
    { key: "headCoverAppliesRestrictedVision", kind: "boolean", default: true,
      label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.HeadCoverRestrictedVision", "Head cover → Restricted Vision"),
    ...
    { key: "heftyBlocksFastStrike", kind: "boolean", default: true,
      label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.HeftyWeaponsBlockFastStrike", "Hefty weapons block Fast Strike"),
...
const FIELD_META = () => Object.freeze({
    attack: Object.freeze([
        ...
        { key: "toHit",     type: "number",  label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.ToHit", "To-Hit")   },
        { key: "dmgMult",   type: "number",  label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.Dmg", "Dmg ×"),   step: "0.5" },
        { key: "attacks",   type: "number",  label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.Attacks", "Attacks"), min: 1 },
        { key: "noDamage",  type: "boolean", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.NoDmg", "No dmg")   },
        { key: "nonLethal", type: "boolean", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.NonLethal", "Non-lethal") },
        { key: "fullRound", type: "boolean", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.FullRound", "Full round") }
    ]),
    defense: Object.freeze([
        { key: "staCost", type: "number", label: "STA"     },
        { key: "penalty", type: "number", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.Penalty", "Penalty") }
    ])
});
...
export class CombatActionsEditor extends HandlebarsApplicationMixin(ApplicationV2) {
    ...
    async _prepareContext() {
        ...
        return {
            ...
            buttons: [
                { type: "button", icon: "fa-solid fa-rotate-left", label: t("WITCHER.App.CombatActionsEditor.Dialog.Button.ResetAllToDefaults", "Reset All to Defaults"), action: "resetCatalog" },
