 ...
 *
 * Extended Combat (WIP) is also managed here. The remaining "rule"-kind
 * toggle (extendedCombat) stays inline in the main settings list; the
 * "houseRule"-kind toggles (splitMovement, rawToxicity) are surfaced by the
 * House Rules configuration menu. The split is driven by each
 * `HOMEBREW[key].kind` ("content" / "rule" / "houseRule") in config.mjs.
 *
