...
export const CE_SUBSYSTEM_DEFAULTS = Object.freeze({
    ...
    actionCosts:  true,
    defenseCosts: true,
    /* Magazine crossbows: capacity-2+ chamber weapons split into loading the
     * magazine (1 action/round) and cocking (reloadActions), and the `repeating`
     * quality decides whether firing keeps you cocked. RAW / capacity 1 keeps
     * the single load-and-cock reload. Defaults ON with CE. */
    magazineReload: true,
