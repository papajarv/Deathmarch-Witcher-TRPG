...
function actionLabelFor(item) {
    ...
    if (kind === "drink") return t("WITCHER.Policy.FoodConsume.Text.Drink", "Drink");
    if (kind === "meal") return t("WITCHER.Policy.FoodConsume.Text.Eat", "Eat");
    return t("WITCHER.Policy.FoodConsume.Text.Consume", "Consume");
}
...
export function installFoodConsumeFeature() {
    ...
    registerItemAction({
        ...
        name: t("WITCHER.Policy.FoodConsume.Text.Consume", "Consume"),
