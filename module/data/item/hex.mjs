    ...
    static defineSchema() {
        return {
            ...
            statusRiders: new fields.ArrayField(new fields.SchemaField({
                ...
                /* See SpellData.statusRiders.staScale for full field docs. */
                ...
                /* See SpellData.statusRiders.staScaleTarget — routes the
                 * resolved staScale value to magnitude / endCheckModifier
                 * / duration / chance. */
                staScaleTarget: new fields.StringField({
                    initial: "magnitude",
                    choices: ["magnitude", "endCheckModifier", "chance"]
                }),
                /* See SpellData.statusRiders.refreshOnRecast. */
