...
export class EnhancementData extends foundry.abstract.TypeDataModel {
    static defineSchema() {
        return {
            ...
            /* Armor-side */
            // Glyph element (SPELL_SCHOOLS: earth/air/fire/water/mixed). When a
            // spell of the SAME element is cast while the glyph's host armor is
            // worn, the caster may claim the glyph's cast bonus (see
            // castSpellMixin._matchingGlyphs). Irrelevant for non-glyph types.
            element:        new fields.StringField({ initial: "mixed" }),
            ...
            // Elemental resistances — mirror ArmorData's binary model.
            fire:           new fields.BooleanField({ initial: false }),
            lightning:      new fields.BooleanField({ initial: false }),
