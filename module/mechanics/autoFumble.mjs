        ...
        return await DialogV2.confirm({
            ...
            content:
                `<div style="padding:8px 0; font-size:0.8125rem;">` +
                    `<div><strong>${escapeHtml(actor.name)}</strong> is about to fumble ` +
                    `<strong>${escapeHtml(FUMBLE_TABLE[category]?.label ?? category)}</strong>.</div>` +
                    `<div style="margin-top:6px;">Spend <strong>5 STA</strong> to ignore the fumble entirely?</div>` +
                    `<div style="margin-top:6px; opacity:0.7; font-size:0.75rem;">Cancel → the fumble table auto-rolls.</div>` +
                `</div>`,
