...
export const BASE_TIERS = Object.freeze([
    { mod:  2, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Bad", "Bad"),     cost:   8 },
    { mod:  1, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Weak", "Weak"),    cost:  15 },
    { mod:  0, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Neutral", "Neutral"), cost:  20 },
    { mod: -1, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Good", "Good"),    cost:  35 },
    { mod: -2, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Great", "Great"),   cost:  50 },
    { mod: -6, label: t("WITCHER.Setup.AlchemyConsts.Dialog.Button.Optimal", "Optimal"), cost: 100 }
]);
