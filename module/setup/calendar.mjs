 ...
 *
 * Twelve Gregorian months (January–December, matching real month lengths incl.
 * a leap-day February), four seasons, and one moon ("the moon") on a 28-day
 * eight-phase cycle.
 */
export const WITCHER_CALENDAR_CONFIG = {
    ...
    months: {
        values: [
            { name: "WITCHER.Calendar.Months.January",   ordinal: 1,  days: 31 },
            { name: "WITCHER.Calendar.Months.February",  ordinal: 2,  days: 28, leapDays: 29 },
            { name: "WITCHER.Calendar.Months.March",     ordinal: 3,  days: 31 },
            { name: "WITCHER.Calendar.Months.April",     ordinal: 4,  days: 30 },
            { name: "WITCHER.Calendar.Months.May",       ordinal: 5,  days: 31 },
            { name: "WITCHER.Calendar.Months.June",      ordinal: 6,  days: 30 },
            { name: "WITCHER.Calendar.Months.July",      ordinal: 7,  days: 31 },
            { name: "WITCHER.Calendar.Months.August",    ordinal: 8,  days: 31 },
            { name: "WITCHER.Calendar.Months.September", ordinal: 9,  days: 30 },
            { name: "WITCHER.Calendar.Months.October",   ordinal: 10, days: 31 },
            { name: "WITCHER.Calendar.Months.November",  ordinal: 11, days: 30 },
            { name: "WITCHER.Calendar.Months.December",  ordinal: 12, days: 31 }
        ]
    },
    days: {
        values: [
    ...
    moons: {
        values: [{
            ...
            /* Icons run DARK→BRIGHT→DARK: an empty ring at new moon, a crescent
             * waxing, half at the quarter, a filled disk from gibbous through
             * full, then back down. (Was inverted — filled at new, empty at full.) */
            phases: [
                { name: "WITCHER.Calendar.Moon.New",            length: 1, icon: "fa-regular fa-circle" },
                ...
                { name: "WITCHER.Calendar.Moon.WaxingGibbous",  length: 6, icon: "fa-solid fa-circle" },
                { name: "WITCHER.Calendar.Moon.Full",           length: 1, icon: "fa-solid fa-circle" },
                { name: "WITCHER.Calendar.Moon.WaningGibbous",  length: 6, icon: "fa-solid fa-circle" },
